...
public interface MobileCodeWSSoap {
    ...
    @RequestWrapper(localName = "getMobileCodeInfo", targetNamespace = "http://WebXml.com.cn/", className = "com.springboot.study.service.ws.GetMobileCodeInfo")
    @ResponseWrapper(localName = "getMobileCodeInfoResponse", targetNamespace = "http://WebXml.com.cn/", className = "com.springboot.study.service.ws.GetMobileCodeInfoResponse")
     ...
     * 
     * @return
     *     returns com.springboot.study.service.ws.ArrayOfString
     */
    ...
    @RequestWrapper(localName = "getDatabaseInfo", targetNamespace = "http://WebXml.com.cn/", className = "com.springboot.study.service.ws.GetDatabaseInfo")
    @ResponseWrapper(localName = "getDatabaseInfoResponse", targetNamespace = "http://WebXml.com.cn/", className = "com.springboot.study.service.ws.GetDatabaseInfoResponse")
